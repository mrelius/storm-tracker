...
def _common_fields(storm: StormObject) -> dict:
    ...
    return dict(
        ...
        storm_radius_mi=getattr(storm, "storm_radius_mi", 5.0),
        ...
        projected_severity_label=getattr(storm, "projected_severity_label", "unknown"),
        impact_severity_label=getattr(storm, "impact_severity_label", "unknown"),
        impact_severity_score=getattr(storm, "impact_severity_score", 0),
